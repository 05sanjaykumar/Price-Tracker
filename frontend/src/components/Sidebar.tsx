...
import {  LayoutDashboard, History, CirclePower, UserCircle } from "lucide-react";
...
const Sidebar = () => {
    ...
    return (
        ...
        >
            ...
            {/* Footer */}
            <button className='flex h-16 shrink-0 items-center justify-center border-t border-gray-800 hover:bg-gray-900' 
